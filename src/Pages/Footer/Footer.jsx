...
const Footer = () => {
  ...
  <nav>
    ...
    <a className="link link-hover hover:text-rose-700">About us</a> 
    <a className="link link-hover hover:text-rose-700">Contact</a> 
    <Link to="/addProduct"><a className="link link-hover hover:text-rose-700">Add product</a></Link> 
   <Link to="/gallery"> <a className="link link-hover hover:text-rose-700">Gallery</a></Link>
  </nav> 
  <nav>
    <header className="footer-title">Legal</header> 
    <a className="link link-hover hover:text-rose-700">Terms of use</a> 
    <a className="link link-hover hover:text-rose-700">Privacy policy</a> 
    <a className="link link-hover hover:text-rose-700">Cookie policy</a>
  </nav>
</footer> 
<footer className="footer px-10 py-4  bg-gray-500 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p className="text-base font-bold">Auto<span className="text-rose-600">motive</span> <br/>Providing reliable tech since 1992</p>
  </aside> 
